...
const Login = () => {
    ...
    return (
        <section className="mx-auto my-[15%] lg:my-[5%] md:my-[7%] lg:p-0 px-[3%] flex justify-center items-center text-[#111410]" data-aos="fade-right">
            <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 font-medium">
                ...
                <div className="my-6 space-y-4">
                    <button aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-[#688165]" onClick={ () => handleSocialLogin(googleLogin) }>
                    ...
                    <button aria-label="Login with GitHub" role="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-[#688165]" onClick={ () => handleSocialLogin(githubLogin) }>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                ...
                <form className="space-y-8" onSubmit={ handleSubmit(onSubmit) }>
                    ...
                    { error && <span className="text-[#B00020] text-sm italic font-semibold opacity-70">{ error }</span> }
